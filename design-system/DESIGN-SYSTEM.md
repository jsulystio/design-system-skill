...
> Generated by `design-system/scripts/build.mjs` from Figma variables (structure: AlignUI Design System 2.0). Do not edit by hand — change the Figma variables (or `tokens/figma.raw.json`) and rebuild. Last built 2026-07-15.
